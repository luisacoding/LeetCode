...
int compareVersion(string version1, string version2)
{
    ...
    while (!v_str1.empty() && v_str1.back() == "")
        v_str1.pop_back();
    while (!v_str2.empty() && v_str2.back() == "")
        v_str2.pop_back();
...
void testCase_CompareVersion()
{
    ...
    cout<<"s1, s2; expected: 1\toutput: "<<compareVersion(s1, s2)<<endl;
    cout<<"s2, s1; expected: -1\toutput: "<<compareVersion(s2, s1)<<endl;
    cout<<"s2, s3; expected: 1\toutput: "<<compareVersion(s2, s3)<<endl;
    cout<<"s2, s4; expected: 0\toutput: "<<compareVersion(s2, s4)<<endl;
    cout<<"s2, s5; expected: 0\toutput: "<<compareVersion(s2, s5)<<endl;
    cout<<"s6, s7; expected: 1\toutput: "<<compareVersion(s6, s7)<<endl;
    cout<<"s6, s8; expected: 0\toutput: "<<compareVersion(s6, s8)<<endl;
    cout<<"s6, s9; expected: 0\toutput: "<<compareVersion(s6, s9)<<endl;  //
    cout<<"s9, s10; expected:-1\toutput: "<<compareVersion(s9, s10)<<endl; //
    cout<<"s9, s14; expected: 1\toutput: "<<compareVersion(s9, s14)<<endl;
    cout<<"s10, s11; expected: -1\toutput: "<<compareVersion(s10, s11)<<endl;
    cout<<"s12, s13; expected: -1\toutput: "<<compareVersion(s12, s13)<<endl;
}
